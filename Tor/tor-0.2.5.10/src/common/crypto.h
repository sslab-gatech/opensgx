...
#ifdef IPC_MODE
int get_crypto_pk_t_refs(crypto_pk_t *tmp);

RSA *get_crypto_pk_t_rsa(crypto_pk_t *tmp);

void set_crypto_pk_t_refs(crypto_pk_t *tmp, int refs);

void set_crypto_pk_t_rsa(crypto_pk_t *tmp, RSA *key);
