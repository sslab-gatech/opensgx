...
#ifdef IPC_MODE
char *get_my_process_info(void);
/*
void set_relay_num(int num);
int get_relay_num();
*/
int router_initialize_tls_context_IPC(int fd_et, int fd_te);
#endif
...
#ifdef IPC_MODE
int
extrainfo_dump_to_string_IPC(char **s_out, extrainfo_t *extrainfo);

char *
router_dump_router_to_string_IPC(routerinfo_t *router);
#endif
