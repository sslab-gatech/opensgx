 ...
 * \return         0 if successful, or an POLARSSL_ERR_RSA_XXX error code
 */
int sgx_rsa_check_pubkey( const rsa_context *ctx );
 ...
 * \return         0 if successful, or an POLARSSL_ERR_RSA_XXX error code
 */
int sgx_rsa_check_privkey( const rsa_context *ctx );
 ...
 */
int sgx_rsa_pkcs1_encrypt( rsa_context *ctx,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng,
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
int sgx_rsa_rsaes_oaep_encrypt( rsa_context *ctx,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng,
                            int mode,
 ...
 *                 an error is thrown.
 */
int sgx_rsa_pkcs1_decrypt( rsa_context *ctx,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng,
 ...
 *                 an error is thrown.
 */
int sgx_rsa_rsaes_pkcs1_v15_decrypt( rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, size_t),
                                 void *p_rng,
                                 int mode, size_t *olen,
                                 const unsigned char *input,
 ...
 *                 an error is thrown.
 */
int sgx_rsa_rsaes_oaep_decrypt( rsa_context *ctx,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng,
                            int mode,
                            const unsigned char *label, size_t label_len,
